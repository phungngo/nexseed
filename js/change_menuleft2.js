function change_menuLeft(){
    ...
    var limit_scroll = $(".main_right").height() - 408;

    var h1 = $(".common_contain .main_cotain .main_right").height();

    var h2 = h1 - 658;

    if ($(".common_contain .main_cotain .main_right").height()>=623&&$(this).scrollTop()<234) {
    ...
    if ($(".common_contain .main_cotain .main_right").height()>=623&&$(this).scrollTop()>235) {
    ...
    if ($(".common_contain .main_cotain .main_right").height()>=623&&$(this).scrollTop()>limit_scroll) {
        $(".common_contain .main_cotain .main_left").removeClass("change_position_menu1");
